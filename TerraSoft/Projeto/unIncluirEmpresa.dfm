inherited frmIncluirEmpresa: TfrmIncluirEmpresa
  Left = 515
  Top = 235
  Caption = 'MANUTEN'#199#195'O EMPRESA'
  ClientHeight = 310
  ClientWidth = 508
  OldCreateOrder = True
  OnCreate = FormCreate
  ...
  inherited PnDados: TPanel
    ...
    object Label16: TLabel
      ...
      Width = 94
      Height = 13
      Caption = 'Al'#237'quota do Simples'
    end
    ...
    object CbxTipoEmpresa: TComboBox
      Left = 117
      Top = 182
      Width = 131
      Height = 21
    ...
    object BtnBuscaMunicipio: TBitBtn
      ...
      Height = 19
      TabOrder = 13
      OnClick = BtnBuscaMunicipioClick
      Glyph.Data = {
