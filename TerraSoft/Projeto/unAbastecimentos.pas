...
begin
  try
    ...
    on e: Exception do
    raise Exception.Create('Não foi possível desmarcar todos os abastecimentos!' + #13 + e.Message);
  end;
end;
...
begin
  try
    ...
    on e: Exception do
    raise Exception.Create('Não foi possível marcar todos os abastecimentos!' + #13 + e.Message);
  end;
end;
...
begin
  try
    ...
    on e: Exception do
    raise Exception.Create('Não foi possível fechar o abastecimento!' + #13 + e.Message);
  end;
end;
...
begin
  try
    ...
    if RdGrpSituacao.ItemIndex < 2 then //  se não for TODOS
