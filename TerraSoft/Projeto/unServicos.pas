...
begin
  inherited;
  if MessageDlg('Deseja realmente excluir o serviço '+cdsDados.FieldByName('descricao').AsString+'?',mtConfirmation,[mbYes,mbNo],0)=mrYes then
    begin
      if cdsDados.FieldByName('codigo').AsString <> trim('') then
        begin
          try
            ...
            MessageDlg('Erro ao excluir o serviço!',mtError,[mbOk],0);
          end;
        end;
