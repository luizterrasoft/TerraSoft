...
begin
  ...
  if telachamando <> 0 then
    begin
      ...
      if telaChamando = 13 then // incluindo compra
        begin
          frmIncluirCompra.edtCodEquipamento.Text := cdsDados.FieldByName('codigo').AsString;
          frmIncluirCompra.lblEquipamento.Caption := cdsDados.FieldByName('descricao').AsString;
        end;
