...
uses
  ...
  type TObjAgenciamento = class
    ...
    public
      ...
      procedure setFk_Agenciamento(piFk_Agenciamento: Integer);
      ...
      function getFk_Agenciamento(): Integer;
...
procedure TObjAgenciamento.setFk_Agenciamento(piFk_Agenciamento: Integer);
begin
  try
    Self.FnFk_Agenciamento := piFk_Agenciamento;
  except
    Self.FnFk_Agenciamento := NUMERO_INDEFINIDO;
  end;
end;

function TObjAgenciamento.getFk_Agenciamento(): Integer;
begin
  Result := Self.FnFk_Agenciamento;
end;
...
procedure TObjAgenciamento.setExibePessoaFisica(const pbMostrarNaoDefinido: Boolean = True);
begin
  ...
  begin
    ...
    begin
      ...
      DM.zQryAgencPessoaFisica.SQL.Add('SELECT * FROM agenc_pessoa_fisica WHERE codigo=:cod');
      DM.zQryAgencPessoaFisica.ParamByName('cod').AsInteger := Self.FnFk_Pessoa_Fisica;
      ...
      if(DM.zQryAgencPessoaFisica.RecordCount = 1)then
        ...
        Self.FsExibePessoaFisica := DM.zQryAgencPessoaFisicaNOME.AsString;
    end;
  end;
end;
...
procedure TObjAgenciamento.setExibePessoaJuridica(const pbMostrarNaoDefinido: Boolean = True);
begin
  ...
  begin
    ...
    begin
      ...
      DM.zQryAgencPessoaJuridica.SQL.Add('SELECT * FROM agenc_pessoa_juridica WHERE codigo=:cod');
      DM.zQryAgencPessoaJuridica.ParamByName('cod').AsInteger := Self.FnFk_Pessoa_Juridica;
      ...
      if(DM.zQryAgencPessoaJuridica.RecordCount = 1)then
        ...
        Self.FsExibePessoaJuridica := DM.zQryAgencPessoaJuridicaNOME.AsString;
    end;
  end;
end;
...
procedure TObjAgenciamento.setExibeImovel(const pbMostrarNaoDefinido: Boolean = True);
begin
  ...
  begin
    ...
    begin
      ...
      DM.zQryAux.ParamByName('codigo').AsInteger := FnFk_Imovel;
...
begin
    ...
    Self.setFk_Agenciamento(NUMERO_INDEFINIDO);
