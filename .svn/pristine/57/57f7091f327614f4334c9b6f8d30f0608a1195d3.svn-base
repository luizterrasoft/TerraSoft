...
uses unCadBairro, unConstantes, unCadCliente, unCadPessoaFisica,
  ...
  unCadClientePessoaJuridica, unPesquisarAgenciamentos, unPesquisarVendas;
...
begin
  ...
  begin
    ...
    begin
      frmPesquisarVendas.FoCidade.codigo := FiCodigo;
      frmPesquisarVendas.FoCidade.nome := FsNome;
    end;
  end;
