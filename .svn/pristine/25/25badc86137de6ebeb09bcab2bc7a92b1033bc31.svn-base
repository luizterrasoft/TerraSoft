...
procedure TfrmPesquisandoProfissao.passarParametro(pTipo:String; pValores:OleVariant);
begin
  inherited;
...
procedure TfrmPesquisandoProfissao.selecionarTodosRegistros();
begin
end;
...
procedure TfrmPesquisandoProfissao.OrdenarGrideRegistrosInciarTela;
var
  sIndexName: String;
...
begin
  ...
  begin
    ...
    begin
      (Self.FoNomeFormChamou as TfrmCadProfissao).passarParametro(PRM_PESQUISOU,null);
...
procedure TfrmPesquisandoProfissao.FormatarValores();
begin
end;
