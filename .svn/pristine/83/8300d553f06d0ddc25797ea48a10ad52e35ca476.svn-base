inherited frmCadPessoaFisica: TfrmCadPessoaFisica
  Left = 462
  Top = 100
  Caption = 'CADASTRO DE PESSOAS F'#205'SICAS - AGENCIADOR'
  ClientHeight = 599
  ClientWidth = 514
  KeyPreview = True
  OldCreateOrder = True
  ...
  inherited grpBxDados: TGroupBox
    ...
    object plsEdConjuge: TPlsEdit
      ...
      TabOrder = 6
      Text = 'PLSEDCONJUGE'
      OnEnter = plsEdConjugeEnter
      OnKeyPress = plsEdConjugeKeyPress
      plsCorRecebeFoco = clSilver
    end
  ...
  inherited ToolBar: TToolBar
    ...
    inherited pnlDicas: TPanel
      ...
      inherited lblDicas: TLabel
        Left = 226
        Hint = 'Dicas do Cadastro Pessoa F'#237'sica - Agenciador'
