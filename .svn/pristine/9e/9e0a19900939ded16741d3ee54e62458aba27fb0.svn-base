inherited frmCadClientePessoaJuridica: TfrmCadClientePessoaJuridica
  Left = 488
  Top = 155
  Caption = 'CADASTRO DE PESSOAS JUR'#205'DICAS - CLIENTE'
  ClientHeight = 563
  ClientWidth = 514
  KeyPreview = True
  OldCreateOrder = True
  ...
  inherited grpBxDados: TGroupBox
    ...
    object plsMedCNPJ: TPlsMaskEdit
      Left = 54
      Top = 74
      Width = 121
      Height = 21
      ...
      TabOrder = 2
      Text = '  .   .   /    -  '
      OnEnter = plsMedCNPJEnter
      OnExit = plsMedCNPJExit
      OnKeyPress = plsMedCNPJKeyPress
      OnKeyUp = plsMedCNPJKeyUp
      plsCorRecebeFoco = clSilver
    end
  ...
  inherited ToolBar: TToolBar
    ...
    inherited pnlDicas: TPanel
      ...
      inherited lblDicas: TLabel
        Left = 224
        Hint = 'Dicas do Cadastro Pessoa Jur'#237'dica - Cliente'
      end
    end
  end
