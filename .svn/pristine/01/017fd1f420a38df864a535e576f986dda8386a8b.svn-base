object frmPesquisar: TfrmPesquisar
  ...
  object dbGrdDadosPesquisa: TDBGrid
    ...
    TitleFont.Style = []
    OnTitleClick = dbGrdDadosPesquisaTitleClick
  end
  ...
  object ppMnPopupMenu: TPopupMenu
    Left = 13
    Top = 174
    object mnItSelecionarTodosRegistros: TMenuItem
      Caption = 'Selecionar Todos Registros...'
      OnClick = mnItSelecionarTodosRegistrosClick
    end
  end
end
