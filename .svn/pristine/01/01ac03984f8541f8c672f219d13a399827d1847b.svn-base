...
begin
  ...
  begin
    Self.FoFuncoes.gravaMensagemSistemaDiversos('procedure TfrmCadSubGrupoBemNegociavel.carregarObjeto();','Acesso Indisponível');
  end;
end;
  ...
  case pnTpSelecao of
    ...
    begin
      try
        ...
        frmSelecionaRegistroGrupoBemNegociavel.passarParametro(PRM_AJUSTAR_LARGURA_GRIDE, null);
        FoFuncoes.AjustarPosicaoFormCadastroSelecaoRegistro(frmPrincipal,
         frmCadSubGrupoBemNegociavel,frmSelecionaRegistroGrupoBemNegociavel,pnlGrupo,ToolBar);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            FoPesquisa.Show;
            FoFuncoes.AjustarPosicaoFormCadastroPesquisa(frmPrincipal, frmCadSubGrupoBemNegociavel, FoPesquisa);
          end;
        end;
      end;
    end;
...
procedure TfrmCadSubGrupoBemNegociavel.lblDicasClick(Sender: TObject);
begin
  inherited;
  FoFuncoes.CriarTelaDicas(FORM_CAD_SUB_GRUPO_BEM_NEGOCIAVEL);
end;
