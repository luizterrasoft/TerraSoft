...
type
  TfrmCadAgenciamento = class(TfrmCadastroBasico)
    ...
    procedure plsMedDataAgenciamentoEnter(Sender: TObject);
    procedure plsMedDataAgenciamentoKeyPress(Sender: TObject;
      var Key: Char);
    procedure plsMedDataBaixaKeyPress(Sender: TObject; var Key: Char);
    procedure plsMedDataBaixaEnter(Sender: TObject);
    procedure rdGrpTipoAgenciamentoEnter(Sender: TObject);
    procedure rdGrpTipoPessoaEnter(Sender: TObject);
    procedure plsEdPessoaEnter(Sender: TObject);
    procedure plsEdPessoaKeyPress(Sender: TObject; var Key: Char);
    ...
    procedure plsEdValorTotalEnter(Sender: TObject);
    procedure plsEdValorTotalKeyPress(Sender: TObject; var Key: Char);
    ...
    procedure lblFinanciamentoBemDescricaoMouseDown(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure lblVistaBemDescricaoMouseDown(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    ...
    procedure plsMedPrazoAutorizacaoKeyPress(Sender: TObject;
      var Key: Char);
    procedure plsMedPrazoAutorizacaoEnter(Sender: TObject);
    procedure plsMedReagenciamentoEnter(Sender: TObject);
    procedure plsMedReagenciamentoKeyPress(Sender: TObject; var Key: Char);
    procedure plsMedReagenciamentoAgenciamentoKeyPress(Sender: TObject;
      var Key: Char);
    procedure plsMedReagenciamentoAgenciamentoEnter(Sender: TObject);
  private
    ...
    procedure BuscarImoveisInteresseSatisfaz(pnCdAgenciamento: Integer);
    function GetCdAgenciamentoInserido: Integer;
  public
...
uses
  ...
  unBuscarImovelInteresseParaAgenciamento, unExibirImoveisInteresseParaAgenciamento,
  DateUtils; //IncDay
...
begin
  ...
  case pnVisib of
    OPC_TELA_INICIO: begin
                       ...
                       plsMedDataAgenciamento.Enabled := False;
                       pnlDataBaixa.Visible := False;
                       ...
                       lblDescFormaPagamento.Visible := True;
...
begin
  ...
  plsMedPrazoAutorizacao.Text := DateToStr(IncDay(Now,40));
end;
...
begin
  ...
  //busca por imóveis de interesse 'parecidos' com este agenciamento
  if(bSalvou)then
    BuscarImoveisInteresseSatisfaz(GetCdAgenciamentoInserido);
...
begin
  ...
  case pnTpSelecao of
    ...
    begin
      if(FbEditarAgenciamentoStandBy)then
      begin
        try
          ...
          // frmCadAgenciamento,frmCadPessoaFisica,pnlPessoa,ToolBar);
      ...
      begin
        try
          ...
          FoFuncoes.AjustarPosicaoFormCadastroSelecaoRegistro(frmPrincipal,
           frmCadAgenciamento,frmSelecionaRegistroPessoaFisica,pnlPessoa,ToolBar,nil,12);
    ...
    begin
      ...
      begin
        try
          ...
          //FoFuncoes.AjustarPosicaoFormCadastroSelecaoRegistro(frmPrincipal,
          // frmCadAgenciamento,frmCadPessoaJuridica,pnlPessoa,ToolBar);
      ...
      begin
        try
          ...
          FoFuncoes.AjustarPosicaoFormCadastroSelecaoRegistro(frmPrincipal,
           frmCadAgenciamento,frmSelecionaRegistroPessoaJuridica,pnlPessoa,ToolBar,nil,12);
    ...
    begin
      ...
      begin
        try
          ...
          frmSelecionaRegistroPessoaJuridica.passarParametro(PRM_ENVIA_FILTRO_PESQUISA, vParametros);
          FoFuncoes.AjustarPosicaoFormCadastroSelecaoRegistro(frmPrincipal,
           frmCadAgenciamento,frmSelecionaRegistroPessoaJuridica,pnlPessoa,ToolBar);
          frmSelecionaRegistroPessoaJuridica.ShowModal;
        finally
          if(Self.FoPessoa.codigo <> NUMERO_INDEFINIDO)then
          begin
...
procedure TfrmCadAgenciamento.BuscarImoveisInteresseSatisfaz(pnCdAgenciamento: Integer);
var
  oImovInteresse: TImovelInteresseParaAgenciamentos;
  frmImoveInt: TfrmImoveisInteresseParaAgenciamento;
begin
  oImovInteresse := TImovelInteresseParaAgenciamentos.CriaObjeto(pnCdAgenciamento);
  if oImovInteresse.GetTotalImovelInteresse > NUMERO_INDEFINIDO then
  begin
    try
      Application.CreateForm(TfrmImoveisInteresseParaAgenciamento,frmImoveInt);
      frmImoveInt.passarParametro(PRM_PASSAR_DATA_SET, oImovInteresse.GetDataSet);
      frmImoveInt.passarParametro(PRM_PASSAR_CODIGO_AGENCIAMENTO,GetCdAgenciamentoInserido);
      frmImoveInt.ShowModal;
    finally
        FreeAndNil(oImovInteresse);
      FoFuncoes.fecharComponentesBD(frmImoveInt);
      FreeAndNil(frmImoveInt);
    end;
  end;
end;

function TfrmCadAgenciamento.GetCdAgenciamentoInserido: Integer;
var
  zQuery: TZQuery;
begin
  try
    ...
    zQuery.Close;
    zQuery.SQL.Clear;
    zQuery.SQL.Add('SELECT codigo FROM agenciamentos ORDER BY codigo DESC ROWS 1');
    zQuery.Open;

    if(zQuery.Active)and(zQuery.RecordCount = 1)then
      Result := zQuery.FieldByName('CODIGO').AsInteger
    else
...
(*  procedure EnviarImovelCadastrado;
  begin
    if(FoImovel.codigo <> NUMERO_INDEFINIDO)then
      frmCadImoveis.passarParametro(PRM_CARREGA_REGISTRO_CODIGO,FoImovel.codigo);
  end;
*)
...
begin
  ...
  begin
    try
      ...
      //EnviarImovelCadastrado;
      //FoFuncoes.AjustarPosicaoFormCadastroSelecaoRegistro(frmPrincipal,
      //  frmCadAgenciamento,frmCadImoveis,pnlImovel,ToolBar);
      frmCadImoveis.passarParametro(PRM_DEFINE_IMOVEL_DE_CADASTRO_IMOVEL,
       TIPO_IMOVEL_DE_VENDA_MEU_AGENCIAMENTO_MEU);
...
begin
  ...
  else if(plsEdPessoa.Text <> STRING_INDEFINIDO)then
...
begin
  ...
  case plsCbBxCondicaoPagamento.ItemIndex of
    ...
    begin
      grpBxCondicaoPagamentoVista.Visible := True;
      grpBxCondicaoPagamentoFinanciamento.Visible := False;
      lblDescFormaPagamento.Visible := False;
      Self.FoCondicaoPagamento := [vista];
    end;
    1:
    begin
...
procedure TfrmCadAgenciamento.lblDicasClick(Sender: TObject);
begin
  inherited;
  FoFuncoes.CriarTelaDicas(FORM_CAD_AGENCIAMENTOS);
end;

procedure TfrmCadAgenciamento.plsMedDataAgenciamentoEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Data do Agenciamento',False);
end;

procedure TfrmCadAgenciamento.plsMedDataAgenciamentoKeyPress(
...
procedure TfrmCadAgenciamento.plsMedDataBaixaKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Data de Baixa do Agenciamento',False);
end;

procedure TfrmCadAgenciamento.plsMedDataBaixaEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Data de Baixa do Agenciamento',False);
end;

procedure TfrmCadAgenciamento.rdGrpTipoAgenciamentoEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Tipo do Agenciamento',True,2);
end;

procedure TfrmCadAgenciamento.rdGrpTipoPessoaEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Tipo de Pessoa',True,2);
end;

procedure TfrmCadAgenciamento.plsEdPessoaEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Nome da Pessoa');
end;

procedure TfrmCadAgenciamento.plsEdPessoaKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
  if(Key=#13)then
    spBtnBuscaPessoaClick(Self);
  MostrarHintCampos(STRING_INDEFINIDO,'Nome da Pessoa');
end;

procedure TfrmCadAgenciamento.plsEdImovelEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Imóvel');
end;

procedure TfrmCadAgenciamento.plsCbBxCondicaoPagamentoKeyPress(
  Sender: TObject; var Key: Char);
begin
  inherited;
...
procedure TfrmCadAgenciamento.plsCbBxCondicaoPagamentoEnter(
  Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Condição de Pagamento',False,2);
...
procedure TfrmCadAgenciamento.plsEdValorTotalEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Valor Total');
end;

procedure TfrmCadAgenciamento.plsEdValorTotalKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Valor Total');
...
procedure TfrmCadAgenciamento.plsEdVistaCachKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
...
procedure TfrmCadAgenciamento.plsEdVistaCachEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Valor à Vista em Cach');
end;

procedure TfrmCadAgenciamento.plsEdVistaBemValorEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Valor à Vista do Bem');
end;

procedure TfrmCadAgenciamento.plsEdVistaBemValorKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Valor à Vista do Bem');
...
procedure TfrmCadAgenciamento.plsMmVistaBemDescricaoKeyPress(
  Sender: TObject; var Key: Char);
begin
  inherited;
...
procedure TfrmCadAgenciamento.plsMmVistaBemDescricaoEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Descrição do Bem dado à Vista',False);
end;

procedure TfrmCadAgenciamento.plsEdFinanciamentoCachEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Valor à Vista em Cach');
end;

procedure TfrmCadAgenciamento.plsEdFinanciamentoCachKeyPress(
  Sender: TObject; var Key: Char);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Valor à Vista em Cach');
...
procedure TfrmCadAgenciamento.plsEdFinanciamentoBemValorKeyPress(
  Sender: TObject; var Key: Char);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Valor à Vista do Bem');
...
procedure TfrmCadAgenciamento.plsEdFinanciamentoBemValorEnter(
  Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Valor à Vista do Bem');
...
procedure TfrmCadAgenciamento.plsMmFinanciamentoBemDescricaoEnter(
  Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Descrição do Bem dado à Vista',False);
...
procedure TfrmCadAgenciamento.plsMmFinanciamentoBemDescricaoKeyPress(
  Sender: TObject; var Key: Char);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Descrição do Bem dado à Vista',False);
...
procedure TfrmCadAgenciamento.plsEdFinanciamentoValorFinanciadoKeyPress(
  Sender: TObject; var Key: Char);
begin
  inherited;
...
procedure TfrmCadAgenciamento.plsEdFinanciamentoValorFinanciadoEnter(
  Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Valor Financiado');
...
procedure TfrmCadAgenciamento.lblFinanciamentoBemDescricaoMouseDown(
  Sender: TObject; Button: TMouseButton; Shift: TShiftState; X,
  Y: Integer);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Descrição do Bem Negociável');
end;

procedure TfrmCadAgenciamento.lblVistaBemDescricaoMouseDown(
  Sender: TObject; Button: TMouseButton; Shift: TShiftState; X,
  Y: Integer);
begin
  inherited;
...
procedure TfrmCadAgenciamento.lblVistaBemDescricaoClick(Sender: TObject);
var
...
procedure TfrmCadAgenciamento.lblFinanciamentoBemDescricaoClick(
  Sender: TObject);
var
  vParametros: OleVariant;
begin
...
procedure TfrmCadAgenciamento.plsMmObservacaoEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Observação do Agenciamento',False);
end;

procedure TfrmCadAgenciamento.plsMmObservacaoKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Observação do Agenciamento',False);
...
procedure TfrmCadAgenciamento.plsMedPrazoAutorizacaoKeyPress(
  Sender: TObject; var Key: Char);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Data do Prazo Agenciamento',False);
end;

procedure TfrmCadAgenciamento.plsMedPrazoAutorizacaoEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Data do Prazo Agenciamento',False);
end;

procedure TfrmCadAgenciamento.plsMedReagenciamentoEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Data do Reagenciamento',False);
end;

procedure TfrmCadAgenciamento.plsMedReagenciamentoKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Data do Reagenciamento',False);
...
procedure TfrmCadAgenciamento.plsMedReagenciamentoAgenciamentoKeyPress(
  Sender: TObject; var Key: Char);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Data do Reagenciamento',False);
...
procedure TfrmCadAgenciamento.plsMedReagenciamentoAgenciamentoEnter(
  Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Data do Reagenciamento',False);
