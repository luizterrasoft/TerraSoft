...
uses
  ...
  StdCtrls, plsEdit, unObjTipoImovel, ExtCtrls;
...
begin
  ...
  FoPesquisa.iniciarTela(frmCadTipoImovel);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          FoFuncoes.AjustarPosicaoFormCadastroPesquisa(frmPrincipal, frmCadTipoImovel, FoPesquisa);
        end;
      end;
    end;
  end;
...
procedure TfrmCadTipoImovel.lblDicasClick(Sender: TObject);
begin
  inherited;
  FoFuncoes.CriarTelaDicas(FORM_CAD_TIPO_IMOVEL);
end;

procedure TfrmCadTipoImovel.plsEdCodigoEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos('Tipo de Imóvel pelo Código',STRING_INDEFINIDO);
end;

procedure TfrmCadTipoImovel.plsEdCodigoKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
  MostrarHintCampos('Tipo de Imóvel pelo Código',STRING_INDEFINIDO);
...
procedure TfrmCadTipoImovel.plsEdNomeEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos('Tipo do Imóvel pelo Nome','Nome do Tipo do Imóvel');
end;

procedure TfrmCadTipoImovel.plsEdNomeKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
  MostrarHintCampos('Tipo do Imóvel pelo Nome','Nome do Tipo do Imóvel');
