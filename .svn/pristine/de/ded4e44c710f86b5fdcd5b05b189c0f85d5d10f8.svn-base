...
type
  ...
  private
    FoImovel: TObjImovel;
    FsImovelDe: String; //MEU,COLEGAS,CONSTRUTORA,TERCEIROS
...
var
  ...
  begin
    ...
    if(FsImovelDe <> TIPO_IMOVEL_DE_VENDA_MEU_AGENCIAMENTO_MEU)and
     (FsImovelDe <> TIPO_IMOVEL_DE_VENDA_MEU_AGENCIAMENTO_COLEGAS)and
     (FsImovelDe <> TIPO_IMOVEL_DE_VENDA_PAUTA_CONSTRUTORA)and
     (FsImovelDe <> TIPO_IMOVEL_DE_VENDA_TERCEIROS)then
      FsImovelDe := TIPO_IMOVEL_DE_VENDA_MEU_AGENCIAMENTO_MEU;
  end;
  ...
  begin
    ...
    begin
      try
        ...
        zQryDados.SQL.Add('valor_imovel,descricao,imovel_de) ');
        ...
        zQryDados.SQL.Add(':val_imo,:des,:imo_de)');
        ...
        zQryDados.ParamByName('val_imo').AsCurrency := dValor;
        zQryDados.ParamByName('des').AsString := plsMmDescricao.Text;
        zQryDados.ParamByName('imo_de').AsString := FsImovelDe;
        limparParametrosNulos();
        zQryDados.ExecSQL();
        DM.ZConnection.Commit;
        bSalvou := True;
...
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Descrição do Imóvel');
end;

procedure TfrmCadImoveis.plsEdTipoImovelEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Tipo de Imóvel');
end;
...
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Estado do Imóvel');
end;
...
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Cidade do Imóvel');
end;
...
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Bairro do Imóvel');
end;
...
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Rua do Imóvel');
end;
...
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'CEP da Rua do Imóvel');
end;
...
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Complemento do Endereço');
end;
...
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Situação do Imóvel',False);
end;
...
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Descrição do Imóvel',False);
end;
