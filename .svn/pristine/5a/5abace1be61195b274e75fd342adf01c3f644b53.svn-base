...
uses unConstantes, unPesquisandoRua, unDM, unSelecionaRegistroBairro, unVariaveis,
  unSelecionaRegistroRua, unDicas, unPrincipal;
...
begin
  ...
  FoPesquisa.iniciarTela(frmCadRua);
...
begin
  ...
  begin
    Result := True;
    MessageDlg('Rua já cadastrado.', mtWarning, [mbOK], 0);
  end
  else
    Result := False;
end;
...
begin
  ...
  case pnVisib of
    ...
    OPC_NOVO:        begin
                       plsEdCodigo.Text := IntToStr(FoFuncoes.RetornarProximoCodigo(TABLE_RUA,True));    
    ...
    begin
      try
        ...
        FoFuncoes.AjustarPosicaoFormCadastroSelecaoRegistro(frmPrincipal,
         frmCadRua,frmSelecionaRegistroBairro,pnlBairro,ToolBar);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          FoFuncoes.AjustarPosicaoFormCadastroPesquisa(frmPrincipal, frmCadRua, FoPesquisa);
        end;
      end;
    end;
  end;
...
procedure TfrmCadRua.plsEdCodigoEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos('Rua pelo Código',STRING_INDEFINIDO);
end;

procedure TfrmCadRua.plsEdNomeEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos('Rua pelo Nome', 'Nome da Rua');
end;

procedure TfrmCadRua.plsEdBairroEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO, 'Nome do Bairro');
end;

procedure TfrmCadRua.plsMedCEPEnter(Sender: TObject);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO, 'CEP da Rua');
end;

procedure TfrmCadRua.lblDicasClick(Sender: TObject);
begin
  inherited;
  FoFuncoes.CriarTelaDicas(FORM_CAD_RUA);
end;

procedure TfrmCadRua.plsEdCodigoKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  MostrarHintCampos('Rua pelo Código',STRING_INDEFINIDO);
end;

procedure TfrmCadRua.plsEdBairroKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO, 'Nome do Bairro');
end;

procedure TfrmCadRua.plsEdNomeKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  MostrarHintCampos('Rua pelo Nome', 'Nome da Rua');
end;

procedure TfrmCadRua.plsMedCEPKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO, 'CEP da Rua');
end;
