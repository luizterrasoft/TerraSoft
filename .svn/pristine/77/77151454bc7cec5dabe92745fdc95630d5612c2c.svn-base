...
begin
  ...
  if(psTable = TABLE_ESTADO)then
    sRetorno := 'GEN_ESTADO'
  else if(psTable = TABLE_CIDADE)then
    sRetorno := 'GEN_CIDADE'
  else if(psTable = TABLE_BAIRRO)then
    sRetorno := 'GEN_BAIRRO'
  else if(psTable = TABLE_RUA)then
    sRetorno := 'GEN_RUA'
  else if(psTable = TABLE_CONSTRUTORA)then
    sRetorno := 'GEN_CONSTRUTORA'
  else if(psTable = TABLE_PROFISSAO)then
    sRetorno := 'GEN_PROFISSAO'
  else if(psTable = TABLE_MEIO_CAPTACAO)then
    sRetorno := 'GEN_MEIO_CAPTACAO'
  else if(psTable = TABLE_CLIENTE_PESSOA_FISICA)then
    sRetorno := 'GEN_CLIENTE_PESSOA_FISICA'
  else if(psTable = TABLE_CLIENTE_PESSOA_JURIDICA)then
    sRetorno := 'GEN_CLIENTE_PESSOA_JURIDICA'
  else if(psTable = TABLE_AGENC_PESSOA_FISICA)then
    sRetorno := 'GEN_AGENC_PESSOA_FISICA'
  else if(psTable = TABLE_AGENC_PESSOA_JURIDICA)then
    sRetorno := 'GEN_AGENC_PESSOA_JURIDICA'
  else if(psTable = TABLE_TIPO_IMOVEL)then
    sRetorno := 'GEN_TIPO_IMOVEL'
  else if(psTable = TABLE_IMOVEL)then
    sRetorno := 'GEN_IMOVEL'
  else if(psTable = TABLE_AGENCIAMENTO)then
    sRetorno := 'GEN_AGENCIAMENTOS'
  else if(psTable = TABLE_IMOVEL_DE_INTERESSE)then
    sRetorno := 'GEN_IMOVEL_DE_INTERESSE'
  else if(psTable = TABLE_VENDAS)then
    sRetorno := 'GEN_VENDAS'
  else if(psTable = TABLE_GRUPO_CONFIGURACAO_IMOVEL)then
    sRetorno := 'GEN_GRUPO_CONFIGURACAO_IMOVEL'
  else if(psTable = TABLE_SUB_GRUPO_CONF_IMOVEL)then
    sRetorno := 'GEN_SUB_GRUPO_CONF_IMOVEL'    
  else if(psTable = TABLE_DICAS)then
    sRetorno := 'GEN_DICAS'
  else if(psTable = TABLE_GRUPO_BEM_NEGOCIAVEL)then
    sRetorno := 'GEN_GRUPO_BEM_NEGOCIAVEL'
  else if(psTable = TABLE_SUB_GRUPO_BEM_NEGOCIAVEL)then
    sRetorno := 'GEN_SUB_GRUPO_BEM_NEGOCIAVEL'
  else if(psTable = TABLE_REGIAO_LOCALIDADE)then
    sRetorno := 'GEN_REGIAO_LOCALIDADE';
