  ...
  type TObjCliente = class
    ...
    public
      ...
      function verificarDiferencaCadastro(pdDataCaptacao:TDate; pnFkProfissao:Integer;
        ...
        pdHoraInicio:TTime; pdHoraFinal:TTime; pdRendimento:Double): Boolean;
  end;
...
procedure TObjCliente.setRendimento(pdRendimento: Double);
begin
  try
...
function TObjCliente.getRendimento(): Double;
begin
...
function TObjCliente.verificarDiferencaCadastro(pdDataCaptacao:TDate;
  ...
  pdHoraFinal:TTime; pdRendimento:Double): Boolean;
var
  retorno: Boolean;
begin
  retorno := False;
