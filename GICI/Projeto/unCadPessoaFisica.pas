...
begin
  ...
  begin
    Self.FoFuncoes.gravaMensagemSistemaDiversos('procedure TfrmCadPessoaFisica.carregarObjeto();','Acesso Indisponível');
  end;
end;
...
begin
  ...
  begin
    bRetorno := True;
    MessageDlg('Pessoa Física já cadastrada.', mtWarning, [mbOK], 0);
  end
  else
  begin
    //cpf igual
    ...
    begin
      ...
      begin
        ...
        begin
          bRetorno := True;
          MessageDlg('Pessoa Física com este CPF já cadastrado.', mtWarning, [mbOK], 0);
        end;
      end;
    end;
  end;
...
begin
  ...
  begin
    MessageDlg('Erro ao pesquisar por pessoa física ao editar agenciamento stand by.', mtWarning, [mbOK], 0);
  end;
end;
...
begin
  inherited;
  MostrarHintCampos(STRING_INDEFINIDO,'Cônjuge do Agenciador');
end;
