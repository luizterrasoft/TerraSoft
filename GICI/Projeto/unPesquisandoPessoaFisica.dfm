inherited frmPesquisandoPessoaFisica: TfrmPesquisandoPessoaFisica
  Left = 428
  Top = 408
  Caption = 'PESQUISANDO PESSOA F'#205'SICA - AGENCIADOR'
  ClientHeight = 174
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited cdsPesquisando: TClientDataSet
    ...
    object cdsPesquisandoDATA_NASCIMENTO: TDateTimeField
      FieldName = 'DATA_NASCIMENTO'
    end
  ...
  object zQryPesquisando: TZQuery
    ...
    SQL.Strings = (
      'SELECT'
      '  p.codigo,p.nome,p.email,p.cpf,p.identidade,p.data_nascimento,'
    ...
    object zQryPesquisandoDATA_NASCIMENTO: TDateTimeField
      FieldName = 'DATA_NASCIMENTO'
    end
