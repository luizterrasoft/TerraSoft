...
uses unDM, unPesquisandoSubGrupoConfImovel, unConstantes,
  ...
  unSelecionaRegistroGrupoConfiguracaoImovel, unVariaveis, unPrincipal;
    ...
    begin
      try
        ...
        FoFuncoes.AjustarPosicaoFormCadastroSelecaoRegistro(frmPrincipal,
         frmCadSubGrupoConfiguracaoImovel,frmSelecionaRegistroGrupoConfiguracaoImovel,pnlGrupo,ToolBar);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            FoPesquisa.Show;
            FoFuncoes.AjustarPosicaoFormCadastroPesquisa(frmPrincipal, frmCadSubGrupoConfiguracaoImovel, FoPesquisa);
          end;
        end;
      end;
    end;
