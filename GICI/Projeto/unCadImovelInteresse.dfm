inherited frmCadImovelInteresse: TfrmCadImovelInteresse
  ...
  inherited grpBxDados: TGroupBox
    ...
    object lblCaracteristicas: TLabel
      ...
      Height = 13
      Cursor = crHandPoint
      Hint = 'Selecionar Caracter'#237'sticas do Im'#243'vel de Interesse'
      ...
      ParentFont = False
      OnClick = lblCaracteristicasClick
    end
    ...
    object plsMedDataCaptacao: TPlsMaskEdit
      ...
      TabOrder = 1
      Text = '  /  /    '
      OnEnter = plsMedDataCaptacaoEnter
      OnKeyPress = plsMedDataCaptacaoKeyPress
      plsCorRecebeFoco = clSilver
    end
    ...
    object pnlTipoImovel: TPanel
      ...
      object spBtnBuscaTipoImovel: TSpeedButton
        ...
        Height = 21
        Cursor = crHandPoint
        Hint = 'Selecionar Tipo do Im'#243'vel'
        Flat = True
        Glyph.Data = {
    ...
    object grpBxFormaPagamento: TGroupBox
      ...
      TabOrder = 9
      object lblDescFormaPagamento: TLabel
        Left = 16
        Top = 56
        Width = 455
        Height = 20
        Caption = 'SELECIONE UMA CONDI'#199#195'O DE PAGAMENTO ACIMA.'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clMaroon
        Font.Height = -16
        Font.Name = 'MS Sans Serif'
      ...
      object grpBxCondicaoPagamentoFinanciamento: TGroupBox
        ...
        object lblFinanciamentoBemDescricao: TLabel
          ...
          Height = 13
          Cursor = crHandPoint
          Hint = 'Selecionar Bem Negoci'#225'vel dado '#224' Vista'
          ...
          Font.Style = [fsItalic, fsUnderline]
          ParentFont = False
          OnClick = lblFinanciamentoBemDescricaoClick
        end
        ...
        object plsEdFinanciamentoCach: TPlsEdit
          ...
          OnEnter = plsEdFinanciamentoCachEnter
          OnKeyPress = plsEdFinanciamentoCachKeyPress
          plsCorRecebeFoco = clSilver
        ...
        object plsEdFinanciamentoBemValor: TPlsEdit
          ...
          OnEnter = plsEdFinanciamentoBemValorEnter
          OnKeyPress = plsEdFinanciamentoBemValorKeyPress
          plsCorRecebeFoco = clSilver
          plsEntraCaracteres = direitaEsquerda
          plsCaracteresAceitos = monetario2
        end
        object plsMmFinanciamentoBemDescricao: TPlsMemo
          ...
          MaxLength = 500
          TabOrder = 3
          OnEnter = plsMmFinanciamentoBemDescricaoEnter
          OnKeyPress = plsMmFinanciamentoBemDescricaoKeyPress
          plsCorRecebeFoco = clSilver
        end
        object plsEdFinanciamentoValorFinanciado: TPlsEdit
          ...
          TabOrder = 1
          Text = 'plsEdFinanciamentoCach'
          OnEnter = plsEdFinanciamentoValorFinanciadoEnter
          OnKeyPress = plsEdFinanciamentoValorFinanciadoKeyPress
          plsCorRecebeFoco = clSilver
          plsEntraCaracteres = direitaEsquerda
          plsCaracteresAceitos = monetario2
        end
      ...
      object grpBxCondicaoPagamentoVista: TGroupBox
        ...
        object lblVistaBemDescricao: TLabel
          ...
          Font.Style = [fsItalic, fsUnderline]
          ParentFont = False
          OnClick = lblVistaBemDescricaoClick
        end
        object plsEdVistaCach: TPlsEdit
          ...
          TabOrder = 0
          Text = 'plsEdVistaCach'
          OnEnter = plsEdVistaCachEnter
          OnKeyPress = plsEdVistaCachKeyPress
          plsCorRecebeFoco = clSilver
          plsEntraCaracteres = direitaEsquerda
          plsCaracteresAceitos = monetario2
        end
        object plsEdVistaBemValor: TPlsEdit
          ...
          OnEnter = plsEdVistaBemValorEnter
          OnKeyPress = plsEdVistaBemValorKeyPress
          plsCorRecebeFoco = clSilver
          plsEntraCaracteres = direitaEsquerda
          plsCaracteresAceitos = monetario2
        end
        object plsMmVistaBemDescricao: TPlsMemo
          ...
          MaxLength = 500
          TabOrder = 2
          OnEnter = plsMmVistaBemDescricaoEnter
          OnKeyPress = plsMmVistaBemDescricaoKeyPress
          plsCorRecebeFoco = clSilver
        end
      end
    end
    object plsMmObservacao: TPlsMemo
      ...
      MaxLength = 500
      TabOrder = 12
      OnEnter = plsMmObservacaoEnter
      OnKeyPress = plsMmObservacaoKeyPress
      plsCorRecebeFoco = clSilver
    end
    object plsCbBxFinalidade: TPlsComboBox
      ...
      OnEnter = plsCbBxFinalidadeEnter
      OnKeyPress = plsCbBxFinalidadeKeyPress
      Items.Strings = (
        'MORAR'
        'INVESTIR')
      plsCorRecebeFoco = clSilver
    ...
    object plsMmCaracteristicas: TPlsMemo
      ...
      MaxLength = 500
      TabOrder = 11
      OnEnter = plsMmCaracteristicasEnter
      OnKeyPress = plsMmCaracteristicasKeyPress
      plsCorRecebeFoco = clSilver
    end
    object plsCbBxCondicaoPagamento: TPlsComboBox
      ...
      OnEnter = plsCbBxCondicaoPagamentoEnter
      OnKeyPress = plsCbBxCondicaoPagamentoKeyPress
      Items.Strings = (
        'VISTA'
    ...
    object plsEdValorImovel: TPlsEdit
      ...
      OnEnter = plsEdValorImovelEnter
      OnKeyPress = plsEdValorImovelKeyPress
      plsCorRecebeFoco = clSilver
      plsEntraCaracteres = direitaEsquerda
      plsCaracteresAceitos = monetario2
    end
    object rdGrpTipoPessoa: TRadioGroup
      ...
      OnEnter = rdGrpTipoPessoaEnter
    end
    object grpBxRegioesLocalidade: TGroupBox
      Left = 4
      Top = 332
      Width = 488
      Height = 126
      Caption = 'Regi'#245'es de Interesse '
      TabOrder = 10
      object dbGrdRegiaoLocalidade: TDBGrid
        Left = 5
        Top = 15
        Width = 446
        Height = 105
        Hint = 'Regi'#227'o Localidade do Im'#243'vel de Interesse'
        DataSource = dsRegiaoLocalidade
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'NOME_REGIAO_LOCALIDADE'
            Width = 428
            Visible = True
          end>
      end
      object pnlAddDeleteRegiaoLocalidade: TPanel
        Left = 451
        Top = 13
        Width = 33
        Height = 54
        ...
        Enabled = False
        TabOrder = 1
        object btBtnDeletarRegiaoLocalidade: TBitBtn
          Left = 2
          Top = 28
          Width = 30
          Height = 25
          Hint = 'Deletar Regi'#227'o Localidade'
          Caption = '-'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -16
          ...
          ParentFont = False
          TabOrder = 0
          OnClick = btBtnDeletarRegiaoLocalidadeClick
        end
        object btBtnAdicionarRegiaoLocalidade: TBitBtn
          Left = 2
          Top = 3
          Width = 30
          Height = 25
          Hint = 'Adicionar Regi'#227'o Localidade'
          Caption = '+'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -16
          ...
          ParentFont = False
          TabOrder = 1
          OnClick = btBtnAdicionarRegiaoLocalidadeClick
        end
      end
    end
  end
  inherited ToolBar: TToolBar
    ...
    inherited pnlDicas: TPanel
      ...
      inherited lblDicas: TLabel
        Left = 312
        Hint = 'Dicas do Cadastro de Im'#243'vel de Interesse'
  ...
  object dsRegiaoLocalidade: TDataSource
    DataSet = cdsRegiaoLocalidade
    Left = 57
    Top = 433
  end
  object cdsRegiaoLocalidade: TClientDataSet
    Aggregates = <>
    FieldDefs = <>
    IndexDefs = <>
    Params = <>
  ...
  object zQryRegiaoLocalidade: TZQuery
    ...
    object zQryRegiaoLocalidadeNOME: TStringField
      FieldName = 'NOME'
      Required = True
      Size = 50
    end
