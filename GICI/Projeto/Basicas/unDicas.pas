...
begin
  case FnTelaDicas of
    ...
    FORM_CAD_GRUPO_BEM_NEGOCIAVEL: frmDicas.Caption := 'Dicas --> Grupo de Configuração de Bem Negociável';
    FORM_CAD_SUB_GRUPO_BEM_NEGOCIAVEL: frmDicas.Caption := 'Dicas --> Sub-Grupo de Configuração de Bem Negociável';
    FORM_CAD_PESSOA_FISICA: frmDicas.Caption := 'Dicas --> Agenciador - Pessoa Física';
    FORM_CAD_PESSOA_JURIDICA: frmDicas.Caption := 'Dicas --> Agenciador - Pessoa Jurídica';
    FORM_CAD_CLIENTE: frmDicas.Caption := 'Dicas --> Cliente - Pessoa Física';
    FORM_CAD_CLIENTE_PESSOA_JURIDICA: frmDicas.Caption := 'Dicas --> Cliente - Pessoa Jurídica';
    FORM_CAD_IMOVEL: frmDicas.Caption := 'Dicas --> Imóvel';
    FORM_CAD_TIPO_IMOVEL: frmDicas.Caption := 'Dicas --> Tipo de Imóvel';
    FORM_CAD_AGENCIAMENTOS: frmDicas.Caption := 'Dicas --> Agenciamento';
    FORM_CAD_IMOVEL_INTERESSE: frmDicas.Caption := 'Dicas --> Imóvel de Interesse';
    FORM_CAD_VENDAS: frmDicas.Caption := 'Dicas --> Venda';
  end;
end;
...
begin
  ...
  case FnTelaDicas of
    ...
    FORM_CAD_GRUPO_BEM_NEGOCIAVEL: zQryDicas.ParamByName('tela').AsString := 'GRUPO DE CONFIGURAÇÃO DE BEM NEGOCIÁVEL';
    FORM_CAD_SUB_GRUPO_BEM_NEGOCIAVEL: zQryDicas.ParamByName('tela').AsString := 'SUB-GRUPO DE CONFIGURAÇÃO DE BEM NEGOCIÁVEL';
    FORM_CAD_PESSOA_FISICA: zQryDicas.ParamByName('tela').AsString := 'AGENCIADOR - PESSOA FÍSICA';
    FORM_CAD_PESSOA_JURIDICA: zQryDicas.ParamByName('tela').AsString := 'AGENCIADOR - PESSOA JURÍDICA';
    FORM_CAD_CLIENTE: zQryDicas.ParamByName('tela').AsString := 'CLIENTE - PESSOA FÍSICA';
    FORM_CAD_CLIENTE_PESSOA_JURIDICA: zQryDicas.ParamByName('tela').AsString := 'CLIENTE - PESSOA JURÍDICA';
    FORM_CAD_IMOVEL: zQryDicas.ParamByName('tela').AsString := 'IMÓVEL';
    FORM_CAD_TIPO_IMOVEL: zQryDicas.ParamByName('tela').AsString := 'TIPO DE IMÓVEL';
    FORM_CAD_AGENCIAMENTOS: zQryDicas.ParamByName('tela').AsString := 'AGENCIAMENTO';
    FORM_CAD_IMOVEL_INTERESSE: zQryDicas.ParamByName('tela').AsString := 'IMÓVEL DE INTERESSE';
    FORM_CAD_VENDAS: zQryDicas.ParamByName('tela').AsString := 'VENDA';
  end;
  zQryDicas.Open;
  cdsDicas.Open;
end;
