...
type
  TfrmPesquisar = class(TForm)
    ...
    procedure dbGrdDadosPesquisaTitleClick(Column: TColumn);
  private
  public
...
procedure TfrmPesquisar.dbGrdDadosPesquisaTitleClick(Column: TColumn);
begin
  FoFuncoes.CriarIndiceOrdenarDadosColuna(cdsDados,Column);
end;
