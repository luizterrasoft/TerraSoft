...
uses
  ...
  type TObjVenda = class
    ...
    private
      ...
      FsTipoCalculoComissao: String[8];
    ...
    public
      ...
      procedure setTipoCalculoComissao(psTipoCalculoComissao: String);
      ...
      function getTipoCalculoComissao(): String;
...
procedure TObjVenda.setTipoCalculoComissao(psTipoCalculoComissao: String);
begin
  try
    FsTipoCalculoComissao := psTipoCalculoComissao;
  except
    FsTipoCalculoComissao := STRING_INDEFINIDO;
  end;
end;

function TObjVenda.getTipoCalculoComissao(): String;
begin
  Result := FsTipoCalculoComissao;
end;
...
begin
    ...
    setTipoCalculoComissao(STRING_INDEFINIDO);
