  ...
  inherited grpBxDados: TGroupBox
    ...
    object pnlDataCancelamento: TPanel
      ...
      object plsMedDataCancelamento: TPlsMaskEdit
        ...
        TabOrder = 0
        Text = '  /  /    '
        OnEnter = plsMedDataCancelamentoEnter
        OnKeyPress = plsMedDataCancelamentoKeyPress
    ...
    object plsMedDataVenda: TPlsMaskEdit
      ...
      TabOrder = 1
      Text = '  /  /    '
      OnEnter = plsMedDataVendaEnter
      OnKeyPress = plsMedDataVendaKeyPress
      plsCorRecebeFoco = clSilver
    end
    ...
    object pnlTipoVenda: TPanel
      ...
      object plsCbBxTipoVenda: TPlsComboBox
        ...
        OnEnter = plsCbBxTipoVendaEnter
        OnKeyPress = plsCbBxTipoVendaKeyPress
        Items.Strings = (
          'MEU AGENCIAMENTO'
          'PAUTA')
        plsCorRecebeFoco = clSilver
      ...
      object plsCbBxImovelDe: TPlsComboBox
        ...
        OnEnter = plsCbBxImovelDeEnter
        OnKeyPress = plsCbBxImovelDeKeyPress
        plsCorRecebeFoco = clSilver
      end
    end
    object pnlConstrutora: TPanel
      ...
      object plsEdConstrutora: TPlsEdit
        ...
        MaxLength = 100
        TabOrder = 0
        OnEnter = plsEdConstrutoraEnter
        OnExit = plsEdConstrutoraExit
        OnKeyPress = plsEdConstrutoraKeyPress
        plsCorRecebeFoco = clSilver
      end
    end
    ...
    object pnlValores: TPanel
      ...
      object plsMedValorVenda: TPlsEdit
        ...
        OnEnter = plsMedValorVendaEnter
        OnKeyPress = plsMedValorVendaKeyPress
        plsCorRecebeFoco = clSilver
      ...
      object plsMedDeducoes: TPlsEdit
        ...
        TabOrder = 1
        Text = 'plsMedDeducoes'
        OnEnter = plsMedDeducoesEnter
        OnKeyPress = plsMedDeducoesKeyPress
        plsCorRecebeFoco = clSilver
        plsEntraCaracteres = direitaEsquerda
      ...
      object plsMedValorBemNegociavel: TPlsEdit
        ...
        OnEnter = plsMedValorBemNegociavelEnter
        OnKeyPress = plsMedValorBemNegociavelKeyPress
        plsCorRecebeFoco = clSilver
        plsEntraCaracteres = direitaEsquerda
        plsCaracteresAceitos = monetario2
      end
      object plsCbBxDeduzirBemNegociavel: TPlsComboBox
        ...
        OnEnter = plsCbBxDeduzirBemNegociavelEnter
        OnKeyPress = plsCbBxDeduzirBemNegociavelKeyPress
        Items.Strings = (
          'SIM'
          'N'#195'O')
        plsCorRecebeFoco = clSilver
      ...
      object plsMedValorCalculoComissao: TPlsEdit
        ...
        OnEnter = plsMedValorCalculoComissaoEnter
        OnKeyPress = plsMedValorCalculoComissaoKeyPress
        plsCorRecebeFoco = clSilver
        plsEntraCaracteres = direitaEsquerda
        plsCaracteresAceitos = monetario2
      end
      ...
      object plsMedPercentualSobreVenda: TPlsEdit
        ...
        OnEnter = plsMedPercentualSobreVendaEnter
        OnKeyPress = plsMedPercentualSobreVendaKeyPress
        plsCorRecebeFoco = clSilver
        plsEntraCaracteres = direitaEsquerda
        plsCaracteresAceitos = percentagem
      end
      object plsMedValorTotalComissao: TPlsEdit
        ...
        OnEnter = plsMedValorTotalComissaoEnter
        OnKeyPress = plsMedValorTotalComissaoKeyPress
        plsCorRecebeFoco = clSilver
        plsEntraCaracteres = direitaEsquerda
        plsCaracteresAceitos = monetario2
      end
      object plsCbBxTipoCalculoComissao: TPlsComboBox
        ...
        OnEnter = plsCbBxTipoCalculoComissaoEnter
        OnKeyPress = plsCbBxTipoCalculoComissaoKeyPress
        Items.Strings = (
          'VENDA'
          'COMISS'#195'O')
        plsCorRecebeFoco = clSilver
