...
begin
  ...
  (* sistema não permite inserir estado
...
begin
  ...
  begin
    ...
    begin
      frmPesquisarAgenciamentos.FoEstado.codigo := FiCodigo;
      frmPesquisarAgenciamentos.FoEstado.nome := FsNome;
    end
    else if(FiTelaChamou = FORM_PESQUISAR_VENDA)then //TfrmPesquisarVendas
    begin
      frmPesquisarVendas.FoEstado.codigo := FiCodigo;
      frmPesquisarVendas.FoEstado.nome := FsNome;
    end;
  end;
