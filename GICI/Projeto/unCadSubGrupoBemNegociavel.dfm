inherited frmCadSubGrupoBemNegociavel: TfrmCadSubGrupoBemNegociavel
  Caption = 'CADASTRO  DE SUB-GRUPO DE BEM NEGOCI'#193'VEL'
  ClientHeight = 164
  KeyPreview = True
  OldCreateOrder = True
  ...
  inherited ToolBar: TToolBar
    inherited pnlDicas: TPanel
      ...
      inherited lblDicas: TLabel
        Left = 101
        Hint = 'Dicas do Cadastro de Sub-Grupo de Configura'#231#227'o de Bem Negoci'#225'vel'
