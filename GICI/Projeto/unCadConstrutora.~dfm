inherited frmCadConstrutora: TfrmCadConstrutora
  ...
  inherited grpBxDados: TGroupBox
    ...
    object plsMedTelefone1: TPlsMaskEdit
      ...
      TabOrder = 2
      Text = '(  )    -    '
      OnEnter = plsMedTelefone1Enter
      OnKeyPress = plsMedTelefone1KeyPress
      plsCorRecebeFoco = clSilver
    end
    object plsMedTelefone2: TPlsMaskEdit
      ...
      TabOrder = 3
      Text = '(  )    -    '
      OnEnter = plsMedTelefone2Enter
      OnKeyPress = plsMedTelefone2KeyPress
      plsCorRecebeFoco = clSilver
    end
  end
  inherited ToolBar: TToolBar
    ...
    inherited pnlDicas: TPanel
      inherited lblDicas: TLabel
        Hint = 'Dicas do Cadastro de Construtoras'
