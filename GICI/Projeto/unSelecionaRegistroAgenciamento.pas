    ...
    begin
      ...
      begin
        if(FbMostraMensagemNaoEncontrouRegistro)then
          MessageDlg('Nenhum agenciamento encontrado.',mtInformation,[mbOK],0);
...
var
  ...
  begin
    ...
    sSQL := sSQL + 'CAST(a.pgto_vista_descricao_bem AS VARCHAR(500)) AS CC_PGTO_VISTA_DESCRICAO_BEM,';
    ...
    sSQL := sSQL + 'CAST(a.pgto_fincto_descricao_bem AS VARCHAR(500)) AS CC_PGTO_FINCTO_DESCRICAO_BEM,';
