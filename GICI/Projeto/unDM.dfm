object DM: TDM
  ...
  object zQryImovel: TZQuery
    ...
    object zQryImovelIMOVEL_DE: TStringField
      FieldName = 'IMOVEL_DE'
      Required = True
      Size = 11
    end
  ...
  object zQryParametrosSistema: TZQuery
    ...
    object zQryParametrosSistemaSERIAL: TStringField
      FieldName = 'SERIAL'
      Size = 120
    end
    object zQryParametrosSistemaCHAVE: TStringField
      FieldName = 'CHAVE'
      Size = 120
    end
    object zQryParametrosSistemaTEMPO_REALIZAR_BACKUP: TIntegerField
      FieldName = 'TEMPO_REALIZAR_BACKUP'
    end
  end
  ...
  object zQryAux: TZQuery
    Connection = ZConnection
    SQL.Strings = (
      'SELECT i.codigo,i.valor_imovel,i.descricao,e.sigla,c.nome '
      'FROM imovel i '
    ...
    Left = 728
    Top = 103
    object zQryAuxCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Required = True
    end
    object zQryAuxVALOR_IMOVEL: TFloatField
      FieldName = 'VALOR_IMOVEL'
    end
    object zQryAuxDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Size = 500
    end
    object zQryAuxSIGLA: TStringField
      FieldName = 'SIGLA'
      Required = True
      Size = 2
    end
    object zQryAuxNOME: TStringField
      FieldName = 'NOME'
      Required = True
      Size = 100
    end
  ...
  object zQryVendas: TZQuery
    ...
    object zQryVendasTIPO_CALCULO_COMISSAO: TStringField
  ...
  object zQryGrupoConfiguracaoImovel: TZQuery
    Connection = ZConnection
    SQL.Strings = (
      'SELECT *'
    ...
    Left = 450
    Top = 298
    object zQryGrupoConfiguracaoImovelCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Required = True
    end
    object zQryGrupoConfiguracaoImovelNOME: TStringField
      FieldName = 'NOME'
      Required = True
      Size = 50
    end
  end
  object zQrySubGrupoConfImovel: TZQuery
    Connection = ZConnection
    SQL.Strings = (
      'SELECT *'
    ...
    Left = 450
    Top = 346
    object zQrySubGrupoConfImovelCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Required = True
    end
    object zQrySubGrupoConfImovelCOD_FK_GRUPO: TIntegerField
      FieldName = 'COD_FK_GRUPO'
      Required = True
    end
    object zQrySubGrupoConfImovelNOME: TStringField
      FieldName = 'NOME'
      Required = True
      Size = 50
    end
  ...
  object zQryGrupoBemNegociavel: TZQuery
    Connection = ZConnection
    SQL.Strings = (
      'SELECT *'
    ...
    Left = 606
    Top = 298
    object zQryGrupoBemNegociavelCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Required = True
    end
    object zQryGrupoBemNegociavelNOME: TStringField
      FieldName = 'NOME'
      Required = True
      Size = 50
    end
  end
  object zQrySubGrupoBemNegociavel: TZQuery
    Connection = ZConnection
    SQL.Strings = (
      'SELECT *'
    ...
    Left = 606
    Top = 346
    object zQrySubGrupoBemNegociavelCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Required = True
    end
    object zQrySubGrupoBemNegociavelCOD_FK_GRUPO: TIntegerField
      FieldName = 'COD_FK_GRUPO'
      Required = True
    end
    object zQrySubGrupoBemNegociavelNOME: TStringField
      FieldName = 'NOME'
      Required = True
      Size = 50
    end
  ...
  object zQryRegiaoLocalidadeBairro: TZQuery
    Connection = ZConnection
    SQL.Strings = (
      'SELECT * FROM regiao_localidade_bairro'
      'WHERE 1=2')
    Params = <>
    Left = 66
    Top = 329
    object zQryRegiaoLocalidadeBairroCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Required = True
    end
    object zQryRegiaoLocalidadeBairroCOD_FK_REGIAO_LOCALIDADE: TIntegerField
      FieldName = 'COD_FK_REGIAO_LOCALIDADE'
      Required = True
    end
    object zQryRegiaoLocalidadeBairroCOD_FK_BAIRRO: TIntegerField
      FieldName = 'COD_FK_BAIRRO'
      Required = True
    end
  end
  object zQryImovInteresseRegiaoLocal: TZQuery
    Connection = ZConnection
    SQL.Strings = (
      'SELECT *'
      'FROM imov_interesse_regiao_local'
      'WHERE 1=2')
    Params = <>
    Left = 449
    Top = 146
    object zQryImovInteresseRegiaoLocalCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Required = True
    end
    object zQryImovInteresseRegiaoLocalCOD_FK_IMOVEL_DE_INTERESSE: TIntegerField
      FieldName = 'COD_FK_IMOVEL_DE_INTERESSE'
      Required = True
    end
    object zQryImovInteresseRegiaoLocalCOD_FK_REGIAO_LOCALIDADE: TIntegerField
      FieldName = 'COD_FK_REGIAO_LOCALIDADE'
      Required = True
    end
  end
  object zQryAuxTotalLogs: TZQuery
    Connection = ZConnection
    SQL.Strings = (
      'SELECT COUNT(codigo) AS total FROM log')
    Params = <>
    Left = 728
    Top = 151
    object zQryAuxTotalLogsTOTAL: TIntegerField
      FieldName = 'TOTAL'
      ReadOnly = True
    end
  end
  ...
  object zQryAuxBackup: TZQuery
    Connection = ZConnection
    SQL.Strings = (
      'SELECT MAX(codigo) AS codigo FROM backup'
      'WHERE 1=2')
    Params = <>
    Left = 727
    Top = 196
    object zQryAuxBackupCODIGO: TIntegerField
      FieldName = 'CODIGO'
      ReadOnly = True
    end
  end
