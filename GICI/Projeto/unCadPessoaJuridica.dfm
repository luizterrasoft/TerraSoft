inherited frmCadPessoaJuridica: TfrmCadPessoaJuridica
  Left = 299
  Top = 122
  Caption = 'CADASTRO DE PESSOAS JUR'#205'DICAS - AGENCIADOR'
  ClientHeight = 563
  ClientWidth = 514
  KeyPreview = True
  OldCreateOrder = True
  ...
  inherited ToolBar: TToolBar
    ...
    inherited pnlDicas: TPanel
      ...
      inherited lblDicas: TLabel
        Left = 226
        Hint = 'Dicas do Cadastro Pessoa Jur'#237'dica - Agenciador'
